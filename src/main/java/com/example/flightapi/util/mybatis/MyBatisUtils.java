package com.example.flightapi.util.mybatis;
...
import com.example.flightapi.core.enums.DbTypeEnum;
import com.example.flightapi.core.pojo.PageParam;
import com.example.flightapi.core.pojo.SortingField;
...
public class MyBatisUtils {
    ...
    public static <T> Page<T> buildPage(PageParam pageParam, Collection<SortingField> sortingFields) {
        ...
        if (!CollectionUtil.isEmpty(sortingFields)) {
            page.addOrder(sortingFields.stream().map(
                sortingField -> SortingField.ORDER_ASC.equals(sortingField.getOrder()) ? OrderItem.asc(
    ...
    public static String findInSet(String column, Object value) {
        ...
        return DbTypeEnum.getFindInSetTemplate(dbType).replace("#{column}", column)
