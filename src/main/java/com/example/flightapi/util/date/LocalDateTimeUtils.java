package com.example.flightapi.util.date;
...
import com.example.flightapi.core.enums.DateIntervalEnum;
...
public class LocalDateTimeUtils {
    ...
    public static String formatDateRange(LocalDateTime startTime, LocalDateTime endTime, Integer interval) {
        ...
        switch (intervalEnum) {
            ...
            case WEEK:
                return LocalDateTimeUtil.format(startTime, DatePattern.NORM_DATE_PATTERN) + StrUtil.format("(第 {} 周)",
                    LocalDateTimeUtil.weekOfYear(startTime));
            case MONTH:
